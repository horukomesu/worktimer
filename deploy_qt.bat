...
REM Deploy Qt dependencies to Release directory
echo Deploying Qt dependencies to Release directory...
"%WINDEPLOYQT_PATH%" ^
    --no-compiler-runtime ^
    --no-translations ^
...
if %ERRORLEVEL% EQU 0 (
    echo.
    echo Qt dependencies deployed successfully to Release directory!
    echo.
